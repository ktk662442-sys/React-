...
//         <br />
//         <button onClick={() => setTime(time + 1)}>upDate</button> // 화살표 함수 사용
//         <button onClick={onClickUp}>downDate</button> // 별도의 함수 사용
//     </>
//   )
// }
...
// export default function UserState() {
//     const [names, setNames] = React.useState(['홍길동', '김철수', '박영희']); // 초기값 배열
//     const [input, setInput] = React.useS(''); // 입력 필드 상태
...
//   return (
//     <>
//         <input type="text" value={input} onChange={handleInputChange}/> // 입력 필드
//         <br />
...
//         <br />
//         <button onClick={handlerLoad}>업로드</button>
...
//         const handlerToggleIson = () => {
//                 setIson(!ison);
//         }
//   return (
//     <div>
//         <button onClick={handlerToggle}>cklick</button>
//         <br />
//         <p>{toggle ? '토글 on' : '토글 off'}</p>

//         <button onClick={handlerToggleIson}>click</button>
//         <br />
//         <p>{ison ? '켜짐' : '꺼짐'}</p>
//     </div>
//   )
...
//     const login = () => {
//         if(name.trim() === '') return // 이름이 비어있으면 로그인하지   않음
